...
/** README GITHUB :: f6b90de on 30 Apr 2011
How can I use it ?
==================
You will have to instanciate your autoloadManager and define
 ...
 * @version GITHUB     2.0
 * @version VALKYRIE     2.1
 * @link https://github.com/alfallouji/PHP-Autoload-Manager PROJECT GITHUB
 */
...
class autoloadManager
{
    ...
    private function saveToFile(array $classes)
    {
        ...
        $content  = '<?php ' . PHP_EOL;
        $content .= '#--[start]SECURITY-READ-FILE--#' . PHP_EOL;
        $content .= 'defined(\'INCLUDES_VALKYRIE\') ? INCLUDES_VALKYRIE : exit;' . PHP_EOL;
        $content .= '#--[end]SECURITY-READ-FILE--#' . PHP_EOL;
        $content .= '?>' . PHP_EOL;
